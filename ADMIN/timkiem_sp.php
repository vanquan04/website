...
<head>
    ...
    <title>Tìm kiếm sản phẩm - Admin Dashboard</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 overflow-y-auto">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-semibold">Kết quả tìm kiếm: "<?php echo htmlspecialchars($keyword); ?>"</h1>
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-between items-center">
                <form method="GET" action="timkiem_sp.php" class="w-full sm:w-1/3 mb-4 sm:mb-0">
                    <div class="flex">
                        <input type="text" name="keyword" value="<?php echo htmlspecialchars($keyword); ?>" placeholder="Tìm kiếm sản phẩm..." class="border rounded-l px-4 py-2 w-full">
                ...
                <div class="flex space-x-2">
                    ...
                    <button class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded transition-colors w-full sm:w-auto" onclick="window.location.href='admin-product.php'">
                        ...
                        <tbody>
                            ...
                            if (!empty($keyword)) {
                                ...
                                $query = "SELECT sp.*, lsp.ten_lsp 
                                          ...
                                          OR sp.mota_ngan_sp LIKE '%$keyword%' 
                                          OR sp.mota_chitiet_sp LIKE '%$keyword%'
                                          OR lsp.ten_lsp LIKE '%$keyword%'
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="7" class="py-4 px-4 text-center">Không tìm thấy sản phẩm phù hợp với từ khóa "<?php echo htmlspecialchars($keyword); ?>".</td>
                                    </tr>
                                    <?php
                                }
                            } else {
                                ?>
                                <tr>
                                    <td colspan="7" class="py-4 px-4 text-center">Vui lòng nhập từ khóa để tìm kiếm.</td>
                                </tr>
                                <?php
                            }
            ...
            <div class="mt-6">
                <div class="bg-white shadow rounded p-4">
                    <?php
                    if (!empty($keyword)) {
                        echo '<div class="text-sm text-gray-600">Hiển thị kết quả tìm kiếm cho "' . htmlspecialchars($keyword) . '"</div>';
                    }
                    ?>
                </div>
            </div>
